...
const Home = () => {
  const { video, setVid, getVideo, handleSearch, searchQuery,setSearchQuery } = useContext(VideoContext);
        ...
        <div className="p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {video.map((video, index) => (
            <div
              ...
              className="bg-white shadow-lg rounded-lg overflow-hidden hover:cursor-pointer hover:scale-110 duration-200"
            >
